...
public class UploadPhoto extends  Thread {
    ...
    public UploadPhoto(Context context, String path, Handler Uihandler){
    ...
    private void doFileUpload(){
        ...
        String exsistingFileName=photoPath;
        if(photoPath.contains("/"))
         exsistingFileName = photoPath.substring(photoPath.lastIndexOf("/")+1);
