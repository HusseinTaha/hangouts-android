 ...
 */
public class UploadPhotoVideo extends  Thread {
    Context context;
    String videoPath;
    String photoPath;
    String URLString="";
    ...
    public UploadPhotoVideo(Context context, String videopath,String photopath, Handler Uihandler){
    ...
    private void doFileUpload(){
        ...
        try
        {
            ...
            if(!photoPath.equals("")){
                ...
                exsistingFileName=photoPath;
                fileInputStream= new FileInputStream(new File((exsistingFileName)));
                dos.writeBytes("Content-Disposition: form-data; name=\"PersonalPicture\";filename=\"" + exsistingFileName +"\"" + lineEnd);
                dos.writeBytes(lineEnd);
