...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    /**
     * The callback interface used by {@link com.deltacall.anim.SwipeDismissTouchListener} to inform its client
     ...
     *                 dismiss this view.
     */
    public SwipeDismissTouchListener(View view, Object token, DismissCallbacks callbacks,Boolean left) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (dismiss) {
                    // dismiss
                //    Log.d("dismiss :","true");
                 //   Log.d("dismiss :",""+(dismissRight ? mViewWidth : -mViewWidth));
                    if((dismissRight ? mViewWidth : -mViewWidth)>0 && left )
                        mView.animate()
            ...
            case MotionEvent.ACTION_MOVE: {
             ...
             //  Log.d("deltaX :",""+deltaX);
              ...
              //  Log.d("mSwipingSlop :",""+mSwipingSlop);
                if(left)
                {    if(Math.abs(deltaX) >223 || mSwipingSlop<0)
                    {
                      //  mSwiping = false;

                      //  Log.d("deltaX :",""+Math.abs(deltaX));
                        if(Math.abs(deltaX) >223 &&  mSwipingSlop>0 ){
                            MotionEvent doEvent = MotionEvent.obtain(motionEvent);
                            doEvent.setAction(MotionEvent.ACTION_DOWN |
                                    (motionEvent.getActionIndex() <<
                                            MotionEvent.ACTION_POINTER_INDEX_SHIFT));
                            mView.onTouchEvent(doEvent);
                            doEvent.recycle();
                        }
                        deltaX=0;
                      return true;
